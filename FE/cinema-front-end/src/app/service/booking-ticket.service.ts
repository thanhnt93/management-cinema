...
export class BookingTicketService {
  ...
  /**
   * Phương thức này dùng để lấy data từ BE truyền sang
   */
  ...
  /**
   * Phương thức này dùng để update thông tin người dùng để vé
   * creator: ThanhNT
   */
  updateStatusTicketByUserName(): Observable<any> {
    console.log(API_URL + '/ticket/update-ticket', this.httpOptions);
    return this.httpClient.patch<void>(API_URL + '/ticket/update-ticket', this.httpOptions);
  }
}
