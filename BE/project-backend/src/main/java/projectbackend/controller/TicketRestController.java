...
public class TicketRestController {
    ...
    /**
     * Phương thức này dùng để update vé ticket chưa thanh toán
     * creator: ThanhNT
     *
     * @param request: dùng để đọc thông tin HttpHeader trong chương trình
     * @return: Nếu update thành công thì trả về HttpStatus.Ok, ngược lại trả về HttpStatus.NotFound
     */
    @PatchMapping("/update-ticket")
...
//        Optional<Ticket> ticket = ticketService.findTicketCustomerByUserName(username);
//        if (ticket.isPresent()) {
//            System.out.println(username + " update-ticket");
//            System.out.println(ticket.get().getStatusTicket());
            ticketService.updateTicketByUserName();
...
//        }
    ...
    /**
     * Phương thức này dùng để trả về api của danh sách vé
     * creator: ThanhNT
     *
     * @param request: dùng để đọc thông tin HttpHeader trong chương trình
     * @return: Nếu list có data thì trả về HttpStatus.Ok, ngược lại trả về HttpStatus.NotFound
     */
    ...
    public ResponseEntity<List<ITicketDto>> showInformationTicket(HttpServletRequest request) {
        ...
        System.out.println(username + " list-ticket");
        // System.out.println(ticketDto.get(0).getNameMovie());
