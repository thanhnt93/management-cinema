...
public class TicketService implements ITicketService {
     ...
     */
    @Override
    public void updateTicketByUserName() {
        ticketRepository.updateTicketByUserName();
    }

    /**
     * creator: ThanhNT
     * @param username: lấy username của người dùng
     * @return: trả về phương thức findTicketCustomerByUserName(username).
     */
    @Override
     ...
     * creator: ThanhNT
     * @param username: lấy username của người dùng
     * @return: trả về phương thức findTicketByUsername(username).
     */
    @Override
    public List<ITicketDto> findTicketByUsername(String username) {
